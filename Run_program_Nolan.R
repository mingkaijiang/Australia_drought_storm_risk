...
### comments: source of error could be:
###           1. calculation of PET;
###           2. spatial coordinates (Australia example)
...
merge_water_deficit_dataframes_and_plot_Nolan(sourceDir="output/Nolan/old",
                                              destDir="output/Nolan",
                                              nswDF)
