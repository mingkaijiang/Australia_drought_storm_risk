compute_antecedent_water_availability_for_user_defined_regions <- function(sourceDir, 
                                                                           destDir, 
                                                                           user.region.name, 
                                                                           duration) {
    ...
    saveRDS(out_percentile, file=paste0(destDir, "/antecedent_water_availability_percentile_", duration,
