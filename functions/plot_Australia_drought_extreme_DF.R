plot_Australia_drought_extreme_DF <- function(sourceDir, destDir, 
    ...
    ### save
    saveRDS(stDF, file=paste0(destDir, "/Drought_extreme_percentile_", duration,
                                        "_Australia.rds"))
    ...
    if (plot.option == T) {
        ...
        ### save plot
        jpeg(paste0(destDir, "/Australia_drought_", duration,
